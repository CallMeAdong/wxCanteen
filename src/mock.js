...
var commentData = [
  {
    ...
    from_uid: Random.integer(1, 1000),
    to_uid: Random.integer(0, 5),
    user_avatar: Random.image(),
    user_name: Random.ctitle(3, 7)
  },
  {
    id: Random.integer(1, 1000),
    topic_id: 1,
...
Mock.mock('/discover/raiders/', 'get', raidersData)
Mock.mock('/discover/comment/', 'get', commentData)
